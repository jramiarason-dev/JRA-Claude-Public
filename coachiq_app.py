...
COACHES: dict[str, dict] = {
    ...
    'giuitta': {
        ...
        'style': 'Défense organisée, jeu collectif, expérience vétérans',
        'philosophy': 'Rigueur défensive et expérience collective',
        'strengths': ['Défense organisée', 'Expérience', 'Jeu intérieur'],
        'weaknesses': ['Lenteur offensive', 'Manque d\'explosivité'],
        'key_principles': ['Défense collective', 'Contrôle du tempo', 'Exploitation du poste bas']
    },
    'kunter': {
        'name': 'Erman Kunter',
        'nationality': '🇹🇷 Turc',
...
TEAM_SQUADS: dict[str, list] = {
    ...
    "JL Bourg-en-Bresse":       [["Léo Cavalière","PG"],["Zach Tuttle","SG"],["Isaiah Pineiro","SF"],["Darel Poirier","PF"],["Christian Kabengele","C"]],
    "Chalon-sur-Saône":         [["Darius Johnson-Odom","PG"],["Axel Bouteille","SG"],["Amine Noua","SF"],["Stevan Jelovac","PF"],["Joffrey Lauvergne","C"]],
    ...
    "BCM Gravelines-Dunkerque": [["Breein Tyree","PG"],["Trevon Bluiett","SG"],["Markel Brown","SF"],["Frank Bartley","PF"],["Brian Quarters","C"]],
...
SCOUTING_SHEETS: dict[str, dict] = {
    ...
    "JL Bourg-en-Bresse": {
        ...
        "playing_style": "Jeu rapide, transition offensive, identité forte et développement des jeunes talents",
        "offensive_system": "Fast break et motion offense, spacing 4-out, exploitation de la vitesse en transition",
        "defensive_system": "Pression défensive haute, zone 3-2, interceptions pour déclencher la transition",
        "key_players": [
            {"name": "Christian Kabengele", "pos": "C",  "flag": "🇨🇩", "age": 27, "strengths": "Défense, rebond offensif, tirs mi-distance", "role": "Pivot pivot intérieur dominant"},
            {"name": "Léo Cavalière",       "pos": "PG", "flag": "🇫🇷", "age": 24, "strengths": "Vitesse, vision de jeu, pénétrations",       "role": "Meneur organisateur de jeu"},
            {"name": "Isaiah Pineiro",      "pos": "SF", "flag": "🇺🇸", "age": 26, "strengths": "Tir extérieur, drives, polyvalence",          "role": "Ailier scoreur"},
        ],
        "stats_profile": {"Rythme": "Élevé", "Défense": "Zone 3-2", "3pts": "35%", "Rebonds": "Mid"},
        "strengths": ["Développement jeunes", "Jeu rapide", "Cohésion d'équipe"],
        "weaknesses": ["Profondeur d'effectif", "Inexpérience playoffs"],
    ...
    "BCM Gravelines-Dunkerque": {
        ...
        "offensive_system": "Iso Bluiett et Tyree, pick and roll, transition après turnover",
        "defensive_system": "Zone 3-2, man agressif, rotations rapides",
        "key_players": [
            {"name": "Trevon Bluiett",   "pos": "SG", "flag": "🇺🇸", "age": 28, "strengths": "Tir extérieur, scoring, créativité",         "role": "Arrière scoreur principal"},
            {"name": "Breein Tyree",     "pos": "PG", "flag": "🇺🇸", "age": 26, "strengths": "Vitesse, drives, scoring",                   "role": "Meneur explosif"},
            {"name": "Markel Brown",     "pos": "SF", "flag": "🇺🇸", "age": 32, "strengths": "Défense, athletisme, leadership",            "role": "Ailier défenseur expérimenté"},
        ],
        "stats_profile": {"Rythme": "Mid", "Défense": "Zone 3-2", "3pts": "34%", "Rebonds": "Élevé"},
        "strengths": ["Défense physique", "Identité nordiste", "Intensité"],
    ...
    "Chalon-sur-Saône": {
        ...
        "coach": "Rémi Giuitta",
        "season_objective": "Maintien Betclic Elite",
        "playing_style": "Jeu collectif défensif, exploitation de l'expérience des vétérans, contrôle du rythme",
        "offensive_system": "Post-up Lauvergne, isolation Johnson-Odom, jeu en demi-terrain positionnel",
        "defensive_system": "Défense en zone, man-to-man, bloc bas discipliné",
        "key_players": [
            {"name": "Joffrey Lauvergne",    "pos": "C",  "flag": "🇫🇷", "age": 33, "strengths": "Poste bas, rebond, leadership",        "role": "Pivot vétéran dominateur"},
            {"name": "Amine Noua",           "pos": "SF", "flag": "🇫🇷", "age": 29, "strengths": "Défense, rebond, tir mi-distance",     "role": "Ailier défenseur polyvalent"},
            {"name": "Darius Johnson-Odom",  "pos": "PG", "flag": "🇺🇸", "age": 34, "strengths": "Création, isolation, leadership",     "role": "Meneur expérimenté"},
        ],
        "stats_profile": {"Rythme": "Lent", "Défense": "Zone", "3pts": "32%", "Rebonds": "Élevé"},
        "strengths": ["Expérience vétérans", "Défense organisée", "Jeu intérieur solide"],
        "weaknesses": ["Manque vitesse", "Peu de créativité extérieure"],
